...
public class DataRoot
{
    ...
    public static void SetData(ConfigFile file, string sectionName, string key, int value) => file.SetValue(sectionName, key, value);
    ...
    public static bool HasData(ConfigFile file, string sectionName, string key) => file.HasSection(sectionName) && file.HasSectionKey(sectionName, key);
