...
/// ファイター2CPU操作
/// </summary>
public partial class CpuFighter2 : CpuFighterRoot
{
    ...
    public override void _Process(double delta)
    {
        ...
        // 必殺技2の射程距離
        if (m_Random.Randf() <= Waza2Probability && m_BackArea.HasFighter(FighterId) is not null && m_AttackArea.HasFighter(FighterId) is not null)
        {
            InsertWaza2();
            return;
        }
